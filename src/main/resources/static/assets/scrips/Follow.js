function getFollow() {
    $.get("/api/user/follow", function(result) {
        ...
        for (const follow of result) {
            res = `
                <li><a href="https://longstestproject.herokuapp.com//profile/${follow.followedId}" style="display: flex;align-items: center;">
                    <img src="https://longstestproject.herokuapp.com//${follow.followAvatar}" alt="" class="avatar" width="36px" height="36px" />
