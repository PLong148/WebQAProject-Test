var userId
var userRole
$.get("https://longstestproject.herokuapp.com/user", function(result) {
    userId = result.id
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            for (var i of result) {
                ...
                res += `
                        <div class="user"> 
                            <a href="https://longstestproject.herokuapp.com/profile/${i.user_id}">
                                <img src="https://longstestproject.herokuapp.com/${i.avatarLink}" alt="" class="avatar" width="40px" height="40px" />
                            </a> 
                            <div class="modify"> 
                                <strong><a class="modifiedby" href="https://longstestproject.herokuapp.com/profile/${i.user_id}">${i.fullName}</a></strong>
                ...
                for (const deleteQuestionBtn of deleteQuestionBtns) {
                    deleteQuestionBtn.addEventListener('click', function(event) {
                        ...
                        if (confirm('Are you sure you want delete this question?')) {
                            $.ajax({
                                url: 'https://longstestproject.herokuapp.com/api/question/' + idQuestion,
                                type: 'delete',
                                success: function(result) {
                                    if (result == true) {
